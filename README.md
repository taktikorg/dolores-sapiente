...
[![Node CI Status](https://github.com/taktikorg/dolores-sapiente/workflows/Node%20CI/badge.svg)](https://github.com/taktikorg/dolores-sapiente/actions)
[![npm](https://img.shields.io/npm/v/@taktikorg/dolores-sapiente.svg)](https://www.npmjs.com/package/@taktikorg/dolores-sapiente)
[![codecov](https://codecov.io/gh/taktikorg/dolores-sapiente/branch/master/graph/badge.svg)](https://codecov.io/gh/taktikorg/dolores-sapiente)
...
```sh
npm install --save @taktikorg/dolores-sapiente
```
...
```js
const { validator } = require('@taktikorg/dolores-sapiente')
...
```js
const { parser } = require('@taktikorg/dolores-sapiente')
...
`@taktikorg/dolores-sapiente` supports the formats specified in JSON schema v4 (such as date-time).
...
When the `includeErrors` option is set to `true`, `@taktikorg/dolores-sapiente` also outputs:
...
See the [doc/samples](./doc/samples/) directory to see how `@taktikorg/dolores-sapiente` compiles
...
`@taktikorg/dolores-sapiente` uses code generation to turn a JSON schema into javascript code that is easily
...
```sh
git clone https://github.com/taktikorg/dolores-sapiente
cd schemasafe
...
Compared to `is-my-json-valid`, `@taktikorg/dolores-sapiente` adds security-first design, many new features,
